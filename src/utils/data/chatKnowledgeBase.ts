...
export const knowledgeBaseES = {
  ...
  experience: {
    keywords: ["experiencia", "trabajo", "trabajado", "empresa", "empleo", "carrera", "profesional", "años", "trayectoria"],
    responses: [
      {
        answer: "Tengo casi 5 años de experiencia como desarrollador frontend. Empecé con prácticas en Incentro (2020), donde luego trabajé 2 años rediseñando webs corporativas y gestionando e-commerce. Después estuve 10 meses en Innova-tsn como consultor frontend. Actualmente (desde mayo 2023) trabajo en AMS Solutions desarrollando aplicaciones críticas para Inditex, donde lidero proyectos de optimización y mentorizo a desarrolladores junior.",
  ...
  innova: {
    ...
    responses: [
      {
        answer: "En Innova-tsn trabajé 10 meses como Front-End Developer/Consultant. Desarrollé componentes para aplicaciones web corporativas, analicé requisitos funcionales y técnicos en colaboración con clientes, y gestioné datos mediante SQL para reporting. Fue mi primera experiencia en consultoría, lo que me enseñó a adaptarme rápidamente a diferentes contextos y comunicar soluciones técnicas de forma clara.",
    ...
    responses: [
      {
        ...
        followUp: ["¿Qué es un BFF exactamente?", "¿Qué bases de datos prefieres?", "¿Eres full-stack?"]
      }
    ]
  },
  ...
  portfolioProject: {
    keywords: ["este portfolio", "esta web", "este proyecto", "como hiciste esto", "como creaste esta pagina"],
    responses: [
      {
        answer: "Este portfolio es mi proyecto personal más completo. Stack: Next.js 14 (App Router), React, TypeScript, Framer Motion, SASS. Backend propio en Node.js/Express/MongoDB desplegado en Vercel. Features únicas: mapa interactivo de viajes con Leaflet, sistema de easter eggs (¡prueba escribiendo 'kunai'!), chat assistant con pattern matching sin costos de API, repos destacados desde GitHub API, y diseño cyberpunk con animaciones. Todo responsive, con i18n (ES/EN), y pensado para demostrar no solo código limpio sino creatividad y atención al detalle.",
  ...
  mentoring: {
    ...
    responses: [
      {
        answer: "En AMS mentorizo a 2-3 desarrolladores junior regularmente. Mi enfoque: 1) Code reviews detallados explicando el 'por qué', no solo el 'qué'. 2) Pair programming en features complejas. 3) Compartir recursos (artículos, documentación, cursos). 4) Crear documentación interna de patrones y convenciones. 5) Fomentar preguntas sin juicio. Creo que un buen mentor no solo enseña código, sino pensamiento crítico, debugging y autonomía. Es gratificante ver su evolución y saber que contribuí a su crecimiento.",
  ...
  location: {
    ...
    responses: [
      {
        answer: "Vivo en Santander, Cantabria, España. Trabajo 100% remoto para AMS desde aquí, colaborando con equipos en Galicia y otras ubicaciones. Tengo 2+ años de experiencia en remoto y me adapto perfectamente: gestión autónoma del tiempo, comunicación asíncrona efectiva, uso de herramientas colaborativas (Slack, Meet, Jira, Confluence). Valoro el remoto por la flexibilidad, pero también disfruto encuentros presenciales ocasionales para fortalecer relaciones con el equipo.",
        followUp: ["¿Prefieres remoto o presencial?", "¿Te mudarías?", "¿Viajas mientras trabajas?"]
      }
    ]
  },
  ...
  // HOBBIES Y PERSONAL
  hobbies: {
    keywords: ["hobbies", "tiempo libre", "aficiones", "gustos", "intereses", "personal", "fuera del trabajo"],
    responses: [
      {
        answer: "Fuera del código: 1) Viajar: he visitado 15+ países. Puedes ver mi mapa interactivo de viajes en el portfolio. Me gusta conocer culturas y probar comidas locales. 2) Anime: fan desde hace años (Naruto, por eso el easter egg kunai 😄). 3) Videojuegos: desde clásicos arcade hasta RPGs modernos. 4) Tecnología: me gusta estar al día con gadgets, IA y tendencias tech. 5) Aprender: actualmente explorando Rust y Web3. Creo que tener intereses variados me hace mejor desarrollador al aportar perspectivas diferentes.",
