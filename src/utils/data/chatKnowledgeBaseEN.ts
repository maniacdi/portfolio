...
export const knowledgeBaseEN: Record<string, KnowledgeCategory> = {
  ...
  // WORK EXPERIENCE
  experience: {
    keywords: ["experience", "work", "worked", "company", "employment", "career", "professional", "years", "trajectory"],
    responses: [
      {
        answer: "I have almost 5 years of experience as a frontend developer. I started with an internship at Incentro (2020), where I then worked for 2 years redesigning corporate websites and managing e-commerce. After that, I spent 10 months at Innova-tsn as a frontend consultant. Currently (since May 2023) I work at AMS Solutions developing critical applications for Inditex, where I lead optimization projects and mentor junior developers.",
        followUp: ["What do you do at AMS?", "What did you achieve in each company?", "Do you work remotely?"]
      }
    ]
  },
  ...
  typescript: {
    ...
    responses: [
      {
        answer: "TypeScript is essential in my daily work. I use it in all my modern projects because it reduces bugs, improves IntelliSense, facilitates refactoring, and serves as living documentation. At AMS we work with TS in critical applications where type safety is fundamental. I also use it in my personal portfolio (frontend and backend). I consider TS practically standard in modern professional JavaScript projects.",
  ...
  hobbies: {
    ...
    responses: [
      {
        answer: "Outside of code: 1) Travel: I've visited 15+ countries. You can see my interactive travel map in the portfolio. I like learning about cultures and trying local foods. 2) Anime: fan for years (Naruto, hence the kunai easter egg 😄). 3) Video games: from classic arcade to modern RPGs. 4) Technology: I like staying current with gadgets, AI, and tech trends. 5) Learning: currently exploring Rust and Web3. I believe having varied interests makes me a better developer by bringing different perspectives.",
  ...
  nextjs: {
    ...
    responses: [
      {
        answer: "I use Next.js 14 with App Router in my portfolio and love it. Key advantages: SSR/SSG out-of-the-box, automatic image optimization, file-based routing, integrated API routes, excellent DX. I've worked with Pages Router and migrated to App Router (Server Components, nested layouts). I also value its SEO optimization and Vercel ecosystem. It's my choice for React projects that need SSR, SEO, or better initial performance.",
